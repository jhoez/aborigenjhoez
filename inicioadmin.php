...
<body>
    ...
    <div class="cajaadmin">
        <h1 id="tad">¡Bienvenido!</h1>
        <h2 id="tad">Has iniciado sesion como:<?php echo $_SESSION['usuario'];?></h2>
            <div id="admp1">
                <h1 id="admti1">Historia del rap en Venezuela</h1>
                <img class="admimgindex" src="img/inde2.jpeg">
            ...
            <div id="admp2">
                <h1 id="admti2">El hip hop en venezuela</h1>
                <img class="admimgindex" src="img/inde.jpg">
                ...
                <h1 id="admti3">Hip hop a la Venezuela</h1>
                <img class="admimgindex" src="img/inde3.jpg">
