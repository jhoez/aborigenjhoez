...
<body id="fondb">
    ...
    <div class="cajagraffi">
        <h1 id="tigraffi">El Arte del graffiti en Venezuela es toda una moda</h1>
        <div id="pgraffiti">
            <h3 id="tigraffi">Las calles de Venezuela se visten de spray</h3>
            <img class="imggraffi" src="img/g3.gif">
